        ...
        <div className="container mx-auto px-8 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="mission-card rounded-2xl p-8 min-h-[520px] border border-border-subtle relative overflow-hidden bg-card">
              <div className="absolute inset-0 bg-cover bg-no-repeat bg-center mission-card-bg" style={{ backgroundImage: 'url(/joseph.png)', filter: 'brightness(0.9) contrast(1.1)', backgroundPosition: 'center 20%' }} />
