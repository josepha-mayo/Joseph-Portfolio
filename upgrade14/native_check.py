...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'public/cutproof/v14';EV=OUT/'evidence'
...
m=json.loads(subprocess.check_output(['node','-e',js,str(OUT/'base-source/src/core.js'),str(ROOT/'upgrade14/binding.cjs'),str(EV/'source.cues.json'),json.dumps(binding)]))
