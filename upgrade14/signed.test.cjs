const assert=require('node:assert/strict'),{test}=require('node:test');const E=require('../public/cutproof/v14/evidence.js'),B=require('../public/cutproof/v14/signed/evidence-baseline.cjs');
const mismatches=[
