"""Same 18 browser workflows, with locator waits that do not require unsafe-eval."""
...
with sync_playwright() as p:
 ...
 browser.close()
report={'status':'passed','origin':base,'count':len(passed),'checks':passed,'scope':'Browser replay of local-EVM recording; no live consensus or real delivery','test_adapter':'Locator waits instead of wait_for_function; no CSP bypass and no application changes.'}
